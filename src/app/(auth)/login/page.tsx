...
function LoginForm() {
  ...
  // Set by the proxy when it bounces a signed-out visitor off a protected
  // route. Relative paths only — an absolute URL here is an open redirect.
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      // Use NextAuth's signIn via the credentials provider
  ...
  return (
    <div>
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 bg-card border border-border rounded-lg px-4 py-3 text-sm font-medium hover:bg-secondary transition-colors mb-6"
      >
